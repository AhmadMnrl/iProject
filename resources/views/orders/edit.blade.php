                ...
                <form action="{{ route('orders.update', $orders->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            {{-- <input type="text" name="customers_id" value="{{ $orders->name }}" placeholder=""
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="date" name="order_date" placeholder="" value="{{ $orders->order_date }}"
                                autocomplete="off" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" name="total_amount" value="{{ $orders->total_amount }}" placeholder=""
